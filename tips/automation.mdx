...
[Webhooks](/integrations/webhooks) let you react to events in real time. When something happens in Crevio, your server gets notified.
...
The [Crevio API](/integrations/api-overview) lets you programmatically manage your store:

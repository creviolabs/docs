...
The Crevio API lets you manage products, pricing, checkouts, orders, customers, and more. All endpoints return JSON with snake_case keys following Stripe conventions.
...
All IDs are string prefix IDs (e.g., `prod_abc123`, `pv_def456`, `cust_ghi789`).

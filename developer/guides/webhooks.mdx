...
You can create webhook endpoints from the dashboard or via the API.
...
The response includes a `secret` field — this is only returned on creation:
...
You can also list available event types:
